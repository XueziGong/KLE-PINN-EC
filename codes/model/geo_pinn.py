...
eigen_path = '.../Geo-PINN/data/eigens/eta=50_var=3/normalize/' # replace with the correct path
...
class pinn(nn.Module):
    ...
    def forward(self, t, z):
        ...
        branch_input_pre = sqrt_eigenvalue * eigen_function
        branch_input = normalize_eigen(branch_input_pre, eigen_min, eigen_range, self.device)
